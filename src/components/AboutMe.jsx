...
const AboutMe = () => {
    ...
    return (
        <div id='about' className=' w-[300px] mx-auto flex flex-col items-center  justify-center gap-5  mt-20 md:w-full md:flex lg:grid lg:grid-cols-2 md:mt-40  border-t py-10 '>
