...
export const data = [
  {
    ...
    description:
      "Landing page desarrollada con NextJs, tailwind css para la customizacion y Framer motion para la implemetacion de animaciones",
    arrow: arrow,
    year: "2024",
    role: "Frontend developer",
    linkGithub: "https://github.com/danielfranchi555/Agenone",
    linkWeb: "https://agenone-zk4d.vercel.app/",
    technologies: ["Nextjs", "Tailwind", "Framer Motion", "Shadcn"],
    type: "Landing",
  },
  {
    id: 2,
    ...
    title: "Gym24",
    description:
      "Landing Page utilizando Nextjs, tailwind css para los estilos y Shadcn para la creacion de algunos componentes ",
    arrow: arrow,
    year: "2024",
    role: "Frontend developer",
  ...
  },
  {
    ...
    title: "Tienda Online",
    description:
      "Tienda online automatizada para que los productos se manden a WhatsApp usando como base de datos Google Sheets ",
    arrow: arrow,
    year: "2024",
    role: "Frontend developer",
    linkWeb: "https://agency-marketing-f6z7.vercel.app/",
    linkGithub: "https://github.com/danielfranchi555/Ecommerce-GoogleSheets",
    technologies: ["GoogleSheets", "React", "Chakra UI"],
    type: "Aplications web",
  },
];
